...
if processes == 1:
    ...
    for i in reduced:
        print "Airline " + str(i) + " had total average delay of : " + str(round(reduced[i][0], 1)) + " minutes"
    ...
    for i in raw:
        print "Airline " + str(i) + " had total average delay of : " + str(round(raw[i][0], 1)) + " minutes"
