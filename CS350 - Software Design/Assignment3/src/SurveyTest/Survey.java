...
public class Survey implements Serializable {
    ...
    public void displaySurveyWithResponses(){
        Output.printString("Survey: " + this.name);
        Output.prtintQuestionWithResponse(this.questions);
        Output.printString("");
    }
    ...
    public void modifyQuestion(int i){
        if(i>=0 && i<this.getNumberOfQuestions()) {
            this.questions.get(i).modifyQuestion();
        }
    }
