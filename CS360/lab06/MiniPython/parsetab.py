...
_lr_productions = [
  ...
  ('program -> stmt_list','program',1,'p_program','interpreterext.py',119),
  ('stmt_list -> stmt SEMICOLON stmt_list','stmt_list',3,'p_stmt_list','interpreterext.py',127),
  ('stmt_list -> stmt','stmt_list',1,'p_stmt_list','interpreterext.py',128),
  ('stmt -> assign_stmt','stmt',1,'p_stmt','interpreterext.py',137),
  ('stmt -> while_stmt','stmt',1,'p_stmt','interpreterext.py',138),
  ('stmt -> if_stmt','stmt',1,'p_stmt','interpreterext.py',139),
  ('stmt -> define_stmt','stmt',1,'p_stmt','interpreterext.py',140),
  ('expr -> expr PLUS term','expr',3,'p_add','interpreterext.py',144),
  ('expr -> expr MINUS term','expr',3,'p_sub','interpreterext.py',148),
  ('expr_list -> expr COMMA expr_list','expr_list',3,'p_expr_list','interpreterext.py',152),
  ('expr_list -> expr','expr_list',1,'p_expr_list','interpreterext.py',153),
  ('expr -> term','expr',1,'p_expr_term','interpreterext.py',161),
  ('term -> term TIMES fact','term',3,'p_mult','interpreterext.py',165),
  ('term -> fact','term',1,'p_term_fact','interpreterext.py',169),
  ('fact -> LPAREN expr RPAREN','fact',3,'p_fact_expr','interpreterext.py',173),
  ('fact -> NUMBER','fact',1,'p_fact_NUM','interpreterext.py',177),
  ('fact -> IDENT','fact',1,'p_fact_IDENT','interpreterext.py',181),
  ('fact -> func_call','fact',1,'p_fact_funcall','interpreterext.py',185),
  ('assign_stmt -> IDENT ASSIGNOP expr','assign_stmt',3,'p_assn','interpreterext.py',189),
  ('while_stmt -> WHILE expr DO stmt_list OD','while_stmt',5,'p_while','interpreterext.py',193),
  ('if_stmt -> IF expr THEN stmt_list ELSE stmt_list FI','if_stmt',7,'p_if','interpreterext.py',197),
  ('define_stmt -> DEFINE IDENT PROC LPAREN param_list RPAREN stmt_list END','define_stmt',8,'p_def','interpreterext.py',201),
  ('param_list -> IDENT COMMA param_list','param_list',3,'p_param_list','interpreterext.py',205),
  ('param_list -> IDENT','param_list',1,'p_param_list','interpreterext.py',206),
  ('func_call -> IDENT LPAREN expr_list RPAREN','func_call',4,'p_func_call','interpreterext.py',214),
]
